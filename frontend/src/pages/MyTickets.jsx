...
const tickets = {
  upcoming: [
    ...
    { event: 'Bad Bunny', date: '12 Ago 2026', time: '21:30 hs', venue: 'Estadio Monumental', code: 'TICKETAPP-2026-BB-1029481', quantity: 1, type: 'VIP', image: events[4].image },
  ],
  past: [
    ...
    { event: 'Hernan Cattaneo', date: '2 Feb 2026', time: '23:00 hs', venue: 'Mandarine Park', code: 'TICKETAPP-2026-HC-1928301', quantity: 4, type: 'VIP', image: events[3].image },
  ],
}
    ...
    <div className="app-shell bg-ticket-alt">
      <header className="border-b border-ticket-border bg-ticket-bg/70 backdrop-blur-xl">
        <div className="container-page flex items-center justify-between py-5">
          <Link to="/" className="font-bold text-gray-300 hover:text-white">Inicio</Link>
          <Logo />
        </div>
      </header>
      <main className="container-page py-8">
        ...
        <div className="mt-8 flex gap-3 rounded-2xl border border-ticket-border bg-ticket-card p-2 sm:w-fit">
          <button onClick={() => setTab('upcoming')} className={`flex-1 rounded-xl px-5 py-3 font-black transition sm:flex-none ${tab === 'upcoming' ? 'bg-ticket-purple text-white shadow-glow' : 'text-gray-400 hover:text-white'}`}>Proximas 2</button>
