...
export default function Header({ cartCount = 0, isLoggedIn = false, searchQuery, setSearchQuery }) {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-ticket-border/70 bg-ticket-bg/80 backdrop-blur-xl">
      <div className="container-page flex items-center gap-4 py-4">
        ...
        <Button to={isLoggedIn ? '/mis-entradas' : '/login'} className="hidden sm:inline-flex">
